...
export async function requestMusicComments(params) {
  return request(
    `${API.music.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestVideoComments(params) {
  return request(
    `${API.video.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function comment(params) {
  return request(
    `${API.comment.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function like(params) {
  return request(
    `${API.like.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
