...
export async function requestArtist(params) {
  return request(
    `${API.list.url}${stringify(params, { addQueryPrefix: true })}`
  )
}

export async function requestSongs(params) {
  return request(
    `${API.songs.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestArtistTop(params) {
  return request(
    `${API.artistTop.url}${stringify(params, { addQueryPrefix: true })}`
  )
}

export async function requestAlbum(params) {
  return request(
    `${API.album.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestDesc(params) {
  return request(
    `${API.desc.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
