...
export async function requestCategoryRecommendation(params) {
  return request(
    `${API.categoryRecommendation.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestCategoryHot(params) {
  return request(
    `${API.categoryHot.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestHotAnchor(params) {
  return request(
    `${API.requestHotAnchor.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestPrograms(params) {
  return request(
    `${API.programs.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
