...
export async function requestHotCategory(params) {
  return request(
    `${API.hotCategory.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestPersonalized(params) {
  return request(
    `${API.personalized.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestDetail(params) {
  return request(
    `${API.detail.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestSimilar(params) {
  return request(
    `${API.similar.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestRelated(params) {
  return request(
    `${API.related.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestSubscribe(params) {
  return request(
    `${API.subscribe.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function createUserPlaylist(params) {
  return request(
    `${API.createUserPlaylist.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function requestUserPlaylist(params) {
  return request(
    `${API.userPlaylist.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function updateUserPlaylist(params) {
  return request(
    `${API.updateUserPlaylist.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function deleteUserPlaylist(params) {
  return request(
    `${API.deleteUserPlaylist.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
...
export async function updateUserPlaylistSongs(params) {
  return request(
    `${API.updateUserPlaylistSongs.url}${stringify(params, { addQueryPrefix: true })}`
  )
}
